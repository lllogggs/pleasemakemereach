...
window.TRANSLATIONS = {
  en: {
    ...
    card2List:`<li>1️⃣ On Trip.com, choose your hotel/flight, enter <strong>stay or travel dates</strong>, then copy the URL.</li><li>2️⃣ Paste that link above and press <strong>'Find'</strong>.</li><li>3️⃣ Click the generated links to <strong>find the best price!</strong></li>`,
    ...
    redirectGuideSteps:[
      'On the Trip.com homepage that opens, type "{query}".',
      'Enter your travel dates.',
      'Press Search.',
      'Copy the search results URL and paste it back into Tripdotdot.'
    ],
    redirectGuidePlaceholder:'your destination or hotel name',
  ...
  ko: {
    ...
    card2Title:"✅ 사용 방법",
    card2List:`<li>1️⃣ 트립닷컴에서 원하는 상품을 찾고 <strong>숙박 기간/여정 날짜</strong>를 입력한 뒤, 주소창의 링크를 복사</li><li>2️⃣ 복사한 링크를 붙여넣고 <strong>'찾기'</strong></li><li>3️⃣ 생성된 국가별 링크를 눌러 <strong>최저가 확인!</strong></li>`,
    ...
    redirectGuideSteps:[
      '연결된 트립닷컴 홈페이지에서 "{query}" 입력',
      '여행일정 입력',
      '검색',
      '검색결과 주소를 복사한 후 다시 트립닷닷에 입력'
    ],
    redirectGuidePlaceholder:'원하는 여행지/호텔명',
  ...
  ja: {
    ...
    card2Title:"✅ ご利用方法",
    card2List:`<li>1️⃣ Trip.comで希望の商品を開き、<strong>宿泊日程や出発日</strong>を入力してからURLをコピーします。</li><li>2️⃣ コピーしたリンクを貼り付けて<strong>「検索」</strong>を押します。</li><li>3️⃣ 生成された各国のリンクから<strong>最安値を確認！</strong></li>`,
    card3Title:"💡 お役立ち情報",
    ...
    redirectGuideSteps:[
      '開いたTrip.comのトップで「{query}」を入力',
      '宿泊日程や旅行日を入力',
      '検索を押す',
      '検索結果ページのURLをコピーしてTripdotdotに貼り付け'
    ],
    redirectGuidePlaceholder:'行き先やホテル名',
  ...
  th: {
    ...
    card2List:`<li>1️⃣ บน Trip.com เลือกโรงแรม/เที่ยวบิน ใส่<strong>วันที่เข้าพักหรือเดินทาง</strong> แล้วคัดลอกลิงก์จากแถบที่อยู่</li><li>2️⃣ วางลิงก์ด้านบนแล้วกด <strong>'ค้นหา'</strong></li><li>3️⃣ คลิกลิงก์ประเทศที่สร้างขึ้นเพื่อ<strong>เช็กราคาถูกสุด</strong></li>`,
    ...
    redirectGuideSteps:[
      'ที่หน้า Trip.com ที่เปิดขึ้น ให้พิมพ์ "{query}"',
      'ใส่วันที่เดินทางหรือเข้าพัก',
      'กดค้นหา',
      'คัดลอก URL ของหน้าผลการค้นหาแล้วกลับมาวางที่ Tripdotdot'
    ],
    redirectGuidePlaceholder:'ปลายทางหรือชื่อโรงแรม',
