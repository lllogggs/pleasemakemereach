...
window.TRANSLATIONS = {
  en: {
    ...
    card2List:`<li>1️⃣ Find a deal on Trip.com and <strong>copy the link.</strong></li><li>2️⃣ Paste the link above and hit <strong>'Find'</strong>.</li><li>3️⃣ Open each country link to <strong>unlock the best price.</strong></li>`,
    ...
    trustTitle:"Save even more on travel costs",
    trustDesc:"Creators using Tripdotdot have already captured over ₩100M in savings across Trip.com.",
    trustMetricSavings:"₩100M+",
    trustMetricBookings:"200+",
    trustMetricCountries:"21+",
    trustStatSavings:"Total savings captured",
    trustStatBookings:"Bookings optimized",
  ...
  ko: {
    ...
    trustMetricBookings:"200+",
    trustMetricCountries:"21+",
    trustStatSavings:"할인받은 구매 금액",
    trustStatBookings:"이용 건수",
  ...
  ja: {
    ...
    card2Title:"✅ ご利用方法",
    card2List:`<li>1️⃣ Trip.comで商品を検索し、<strong>リンクをコピー</strong>します。</li><li>2️⃣ コピーしたリンクを貼り付けて<strong>「検索」</strong>。</li><li>3️⃣ 表示された各国のリンクから<strong>最安値をチェック！</strong></li>`,
    card3Title:"💡 お役立ち情報",
    ...
    trustTitle:"旅費をもっとおトクに",
    trustDesc:"Tripdotdot経由の割引購入額は累計₩1億を突破。あなたの予約ももっと賢く。",
    trustMetricSavings:"₩1億+",
    trustMetricBookings:"200+",
    trustMetricCountries:"21+",
    trustStatSavings:"累計割引購入額",
    trustStatBookings:"最適化された予約件数",
  ...
  th: {
    ...
    card2List:`<li>1️⃣ ค้นหาดีลใน Trip.com แล้ว<strong>คัดลอกลิงก์</strong></li><li>2️⃣ วางลิงก์ด้านบนแล้วกด<strong>'ค้นหา'</strong></li><li>3️⃣ เลือกลิงก์ประเทศที่สร้าง เพื่อ<strong>ดูราคาดีที่สุด</strong></li>`,
    ...
    trustDesc:"ผู้ใช้ Tripdotdot ประหยัดเงินบน Trip.com ไปรวมกว่า ₩100M แล้ว ถึงเวลาของคุณบ้าง",
    trustMetricSavings:"₩100M+",
    trustMetricBookings:"200+",
    trustMetricCountries:"21+",
    trustStatSavings:"ยอดประหยัดที่ทำได้",
    trustStatBookings:"จำนวนการใช้งาน",
