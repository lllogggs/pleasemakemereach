...
window.TRANSLATIONS = {
  en: {
    ...
    unsupportedDomainBody:"Tripdotdot works with Trip.com URLs only. Open Trip.com, search for your stay or flight, then paste that full address here.",
    unsupportedDomainCta:"Open Trip.com",
    unsupportedDomainLogic:"We convert only trip.com and its subdomains (e.g., www.trip.com, kr.trip.com).",
  ...
  ko: {
    ...
    unsupportedDomainBody:"붙여넣은 주소가 Trip.com 링크가 아니에요. Trip.com에서 숙소나 항공권을 검색한 뒤 주소창의 전체 URL을 복사해 주세요.",
  ...
  ja: {
    ...
    unsupportedDomainBody:"貼り付けられたURLがTrip.comではありません。Trip.comでホテルや航空券を検索し、アドレスバーのフルURLをコピーしてください。",
    unsupportedDomainCta:"Trip.comを開く",
    unsupportedDomainLogic:"trip.comとそのサブドメインのみ変換します。（例: www.trip.com、kr.trip.com）",
  ...
  th: {
    ...
    unsupportedDomainBody:"ลิงก์ที่วางไว้ไม่ใช่ของ Trip.com โปรดเข้า Trip.com ค้นหาโรงแรมหรือเที่ยวบิน แล้วคัดลอก URL แบบเต็มจากแถบที่อยู่",
    unsupportedDomainCta:"เปิด Trip.com",
    unsupportedDomainLogic:"รองรับเฉพาะ trip.com และซับโดเมน (เช่น www.trip.com, kr.trip.com)",
